...
public class PivotOnLeftWheelCommand extends LoggingCommand {
    ...
    public PivotOnLeftWheelCommand(double speed, double targetHeading, boolean brakeAtEnd, double timeoutTimeMS,
