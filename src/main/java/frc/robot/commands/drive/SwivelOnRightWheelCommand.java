...
public class SwivelOnRightWheelCommand extends LoggingCommand {
    ...
    public SwivelOnRightWheelCommand(double speed, double targetHeading, boolean brakeAtEnd, double timeoutTimeMS,
